...
def _get_available_detectors() -> List[Detector]:
    all_imports = []
    try:
        from jackdaw.detectors.torch import TorchDetector, TorchSeqDetector
        all_imports = all_imports + [TorchSeqDetector, TorchDetector]
    except (ImportError, NameError):
        pass
    try:
        from jackdaw.detectors.torch_geo import TorchGeoSeqDetector
